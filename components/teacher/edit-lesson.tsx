...
export function EditLesson({ lessonId, onBack, onSave }: EditLessonProps) {
  ...
  useEffect(() => {
    ...
    const fetchLesson = async () => {
      ...
      // Fetch pregunta data for sound/voice/fill/sequence activities
      ...
      if (actsNeedingPregunta.length > 0) {
        ...
        for (const act of acts) {
          if (act.type === "sequence") {
            ...
            act.sequence_steps = steps.map((p: any) => ({
              ...
              <CardContent className="space-y-4">
                ...
                {(actImagePreview || actExistingImageUrl) ? (
                  <div className="relative">
                    <img src={actImagePreview || actExistingImageUrl} alt="Vista previa" className="w-full max-h-64 object-contain rounded-lg border-2 border-border bg-muted" />
